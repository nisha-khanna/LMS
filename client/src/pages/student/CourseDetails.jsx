...
const CourseDetails = () => {
 ...
 const toggleSection =(index)=>{
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-16 pt-10 text-left'>
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b
      from-cyan-100/70'></div>
      {/*left*/}
     <div className='max-w-xl z-10 text-gray-500'>
    <h1 className='md:text-course-details-heading-large md:text-course-details-heading-small font-semibold text-gray-800'>
    ...
    dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,200)}}></p>
      ...
      {/*review and ratings*/}
       <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
             ...
             <p className='text-sm'> Course by <span className='text-blue-600 underline'>GreatEdu</span></p>
    ...
    dangerouslySetInnerHTML={{__html: courseData.courseDescription}}></p>
      ...
      {/*right*/}
     <div className='max-w-course-card shadow-custom-card z-10 rounded-t md:rounded-none 
  ...
  >{isAlreadyEnrolled?'Already Enrolled':'Enroll Now'}</button>
   ...
   <div className='pt-6'>
    ...
    <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
      <li>
        Lifetime access with free updates. </li>
        <li>Step-by-step,hands-on project guidance.</li>
        <li>Downloadable resources and source code.</li>
        <li>Quixzes to test your knowledge.</li>
