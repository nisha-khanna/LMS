    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
     ...
     md:gap-32 py-10 border-b border-white/30'>
        ...
        <p className='mt-6 text-center md:text-left text-sm text-white/80' >Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          It has been the industry's standard text.  </p>
        </div>
         <div className='flex flex-col md:items-start items-center w-full'>
          <h2 className='font-semeibold text-white mb-5'>Company</h2>
     ...
     <p className=' mt-2 py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025.All Right Reserved.</p>
    </footer>
  )
}
