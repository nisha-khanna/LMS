...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Whether you’re a beginner or advancing your skills, explore
       personalized paths, track progress, and achieve your goals at your own pace."</p>
